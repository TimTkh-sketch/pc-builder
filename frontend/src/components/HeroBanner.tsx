  ...
  return (
    <div className="relative h-full flex items-center overflow-hidden">
      ...
      <div className="relative z-10 px-10 md:px-16 max-w-2xl">
        <div className="inline-flex items-center gap-2 bg-blue-500/15 border border-blue-500/30 rounded-full px-3 py-1 text-blue-300 text-xs font-medium mb-5">
    ...
    <div className="relative h-full flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-10 md:px-16">
        <div className="flex items-end justify-between mb-6">
          <div>
            <p className="text-purple-400 text-sm font-medium mb-1">Готовые конфигурации</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {showcase.map((b) => (
            ...
            >
              ...
              <p className="text-white text-sm font-semibold leading-snug line-clamp-2 group-hover:text-blue-300 transition-colors mb-2">
                {b.name}
              </p>
              {b.total_price && (
                <p className="text-xs text-gray-400">
                  ...
                  <span className="text-white font-bold">
                    {Math.round(b.total_price / 1000)}к ₽
                  </span>
                </p>
              )}
            </Link>
...
export default function HeroBanner() {
  ...
  return (
    <div
      className="relative w-full h-72 md:h-80 rounded-2xl overflow-hidden"
